...
| 4 | Closed loop | Integrate AIN0 (D14) velocity at 500 Hz to advance frames — `fps = V · 100 · gain/10` (G3-faithful: `gain` is 10× the gain, 10 = unity = 100 fps/V, 2–5 = 20–50 fps/V; EWMA-smoothed input) |
