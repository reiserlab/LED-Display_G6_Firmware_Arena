...
// Hardcoded panel map for the G6_2x10 arena (arena_10-10 v1 production board
// populated with 2 panel rows -- the CSHL course controllers).
// Included only from ../ArenaConfig.h when ARENA_HW_2_10 is defined; relies
...
#define ARENA_HW_CS_DECODE_TIE_HIGH 1
