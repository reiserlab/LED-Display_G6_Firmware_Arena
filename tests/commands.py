...
GET_I2C_SCAN_CMD            = 0xA6   # [01 A6] Qwiic (Wire1) bus scan; returns [count, addr...] 7-bit addresses that ACKed
I2C_TRANSFER_CMD            = 0xA7   # [len A7 addr wlen w... rlen] Qwiic write-then-read (repeated start); returns rlen bytes
